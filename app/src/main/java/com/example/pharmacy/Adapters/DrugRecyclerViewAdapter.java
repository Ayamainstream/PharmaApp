 ...
 */
public class DrugRecyclerViewAdapter extends RecyclerView.Adapter<DrugRecyclerViewAdapter.FoodViewHolder> {
     ...
     */
    public DrugRecyclerViewAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull FoodViewHolder holder, int i) {
        ...
        if (currentFood.getCount() > 0) { // add order to cart
            ...
            holder.button.setText("Удалить заказ");
            ...
            holder.button.setText("Заказать сейчас");
